...
class Product(models.Model):
    ...
    def __repr__(self):
        return 'product ({}) with name {}'.format(self.id, self.name)
...
class ShoppingCart(models.Model):
    ...
    def __repr__(self):
        return 'ShoppingCart object ({}) with name "{}" and address "{}"'.format(self.id, self.name, self.address)
...
class ShoppingCartItem(models.Model):
    ...
    def __repr__(self):
        return 'ShoppingCartItem ({}) with name {} and quantity {}'.format(self.id, self.product.name,
                                                                           self.quantity)